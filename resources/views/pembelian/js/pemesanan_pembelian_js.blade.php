<script>
    $(document).ready(function () {
        ...
        $(document).off('submit', '#form_pemesanan_pembelian').on('submit', '#form_pemesanan_pembelian', function (e) {
            e.preventDefault();
            ...
            $.ajax({
                url: '{{ route("pembelian_pemesanan.store") }}',
                data: formdata,
                method: 'post',
                success: function (data) {
                    var obj = JSON.parse(data);
                    ...
                    if (obj.status == 200) {
                        ...
                        Swal.fire({
                            ...
                            didOpen: () => {
                                ...
                                var pageurl = "<?= secure_url('pembelian') ?>";

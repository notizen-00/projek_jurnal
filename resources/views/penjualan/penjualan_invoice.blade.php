    ...
    <div class="row">
        <div class="col-lg-12 col-12">
            <div class="card">
                <div class="card-header" style="height:80px;">
                    <div class="d-flex justify-content-between">
                        <h4 style="margin-top:-1px;">Buat Penagihan Penjualan</h4>
                        <a class="btn btn-info refresh_penjualan_invoice"><i class="fas fa-sync"></i> Refresh Page</a>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form id="form_penjualan" class="ml-4 mt-2">
                            @csrf
                            <div class="card-header" style="background-color:lightblue; height:100px;">

                                <div class="row">
                                    <input type="hidden" name="tipe_penjualan" value="1" />
                                    <div class="form-group col-lg-2 col-md-6 col-sm-12">
                                        <label for="supplier" class="text-dark"><b>Pelanggan</b></label>
                                        <br>
                            ...
                            <div class="row col-12 justify-content-between">
                                ...
                                <div class="col-lg-6 col-sm-12 pr-5 justify-content-around">
                                    ...
                                    <div class="form-group col-lg-6 col-sm-12 float-left">
                                        <label for="supplier" class="text-dark"><b>Sales</b></label>
                            ...
                            <div class="row justify-content-end mr-4">
                                ...
                                <input type="checkbox" id="toggle_pajak" checked data-toggle="toggle" data-width="200"
                                    data-height="20" data-on="Tidak Termasuk Pajak" data-off="Harga Termasuk Pajak"
                                ...
                                <table class="table table-striped table-hover" id="table_pembelian"
                                    ...
                                    <thead style="background-color:aliceblue;" class="text-lowercase">
                                        <tr>
                                            ...
                                            <th style="font-size:smaller;" class="text-capitalize">Gudang</th>
                                    ...
                                    <tbody class="isi_produk">
                                        <tr>
                                            ...
                                            <td style="width:5%;"><input type="text"
                                                    class="form-control form-control-sm stok" name="stok" readonly></td>
                                            <td style="width:10%;">
                                ...
                                <div class="row col-12 justify-content-between">
                                    ...
                                    <div class="col-lg-6 col-sm-12 text-right pr-5 justify-content-between">
                                        <div class="pr-5 col-lg-6 col-sm-12 float-left">
                                            SubTotal
                                            <input type="hidden" name="subtotal_akun">
                                        </div>
                            ...
                            <div class="row justify-content-end col-12">
                                ...
                                <button type="submit" class="btn btn-md btn-success hasil">Buat Penjualan</button>
        ...
        @push('custom-scripts')
            @include('penjualan.js.penjualan_js')
            @include('penjualan.js.supplier_js')
        @endpush

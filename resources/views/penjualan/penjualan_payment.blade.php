...
<div class="content">
    <div class="row">
            ...
            <div class="card">
                <div class="card-header" style="height:80px;">
                    <div class="d-flex justify-content-between">
                        <b>Transaksi</b>
                        <h4 style="margin-top:-1px;">Terima Pembayaran</h4>
                    ...
                    <div class="card">
                        ...
                        <form id="form_pembayaran" class="ml-4 mt-2">
                            ...
                            <div class="card-header" style="background-color:lightblue; height:100px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-2 col-md-6 col-sm-6">
                                        <label for="supplier" class="text-dark"><b>Setor Ke</b></label>

                                        <select class="form-control form-control-sm" required name="akun_transaksi_debit"
                                            style="height:30px; font-size:smaller; padding-top:3px;">
                                    ...
                                    <div class="total text-right col-lg-3 col-md-6 col-sm-12 ml-auto">
                                        ...
                                        <h3 style="color:#4287f5;" class="total_view">{{ \Helper::rupiah($sisa_tagihan) }}</h3>
                                    </div>
                                ...
                                <table class="table table-striped table-hover" id="table_pembayaran"
                                    ...
                                    <thead style="background-color:aliceblue;" class="text-lowercase">
                                        <tr>
                                            ...
                                            <th style="font-size:smaller;" class="text-capitalize text-left">Sisa Tagihan
                                            </th>
                                    ...
                                    <tbody class="isi_produk">
                                       <tr>
                                            <td><a href="{{ route('penjualan.show',$detail->id) }}">{{ $detail->no_transaksi }}<input name="no_transaksi_penjualan" value="{{ $detail->no_transaksi }}" type="hidden"></a></td>
                                            <td></td>
                                            <td>{{ $detail->tgl_jatuh_tempo }}</td>
                                            <td>{{ \Helper::rupiah($detail->total) }}</td>
                                            <td>{{ \Helper::rupiah($sisa_tagihan) }}</td>

                                            <td><input type="text" name="jumlah_pembayaran" value="{{ $sisa_tagihan }}" class="form-control form-control-sm"> </td>
                            ...
                            <div class="row justify-content-end col-12">
                                ...
                                <button type="submit" class="btn btn-md btn-success hasil">Terima Pembayaran</button>
        ...
        @push('scripts')
            @include('penjualan.js.penjualan_payment_js')

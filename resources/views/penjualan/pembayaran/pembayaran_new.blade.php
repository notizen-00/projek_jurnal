...
<div class="content">
    <div class="row">
            ...
            <div class="card">
                <div class="card-header" style="height:80px;">
                    <div class="d-flex justify-content-between">
                        <div>
                            <b>Transaksi</b><br>
                            <a href="{{ route('pembayaran_penjualan.list') }}" class="btn btn-danger btn-sm" >Kembali ke List</a>
                        </div>
                        <h4 style="margin-top:-1px;">Penerimaan Pembayaran</h4>
                    ...
                    <div class="card">
                        ...
                        <form id="form_payment" class="ml-4 mt-2">
                            ...
                            <div class="row justify-content-end col-12">
                                ...
                                <button type="submit" class="btn btn-md btn-success hasil mb-3 mr-2">Terima Pembayaran</button>
        ...
        @push('custom-scripts')
            @include('penjualan.js.pembayaran_new_js')

    ...
    $(document).ready(function () {
        ...
        $("[name=supplier]").on('change', function () {
            ...
            if (supplier == '') {
                ...
                alert('Isikan dulu data Kontak Pelanggan');
            } else {
                ...
                $.ajax({
                    url:"<?= url('ajax/penjualan/data_transaksi') ?>",
        ...
        searchTransaksi.on('change', function (e) {
            ...
            $.ajaxSetup({
                ...
                $.ajax({
                    url: "<?= url('ajax/get_penjualan/data_transaksi') ?>",
                    method: 'POST',
                    data: {
                        no_transaksi: isi
                    },
                    success: function (data) {
                        ...
                        if (data[0].sisa_tagihan == 0) {
                            ...
                            html += '<tr>' +
                                '<td><input type="hidden" name="no_transaksi_penjualan[]" value="' +
                                obj[0].data.no_transaksi + '"> ' + obj[0].data
                                .no_transaksi + '</td>' +
                                '<td>' + msg + '</td>' +
                                '<td>' + obj[0].data.detail_penjualan.tgl_jatuh_tempo +
                                '</td>' +
